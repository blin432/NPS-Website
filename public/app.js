            ...
            "<div class='modal-dialog' role='document'>" +
                "<div class='modal-content'>" +
                    ...
                    "<div class='modal-footer'>" +
                        "<img class='thumbs-pic' height='20px' width='20px' src='./images/pngguru.com.png'><img class='thumbs-pic' height='20px' width='20px' src='./images/PinClipart.com_walking-dead-clip-art_727656.png'> <button type='button' class='btn btn-secondary' data-dismiss='modal'>Close</button>" +
                    "</div>" +
                "</div>" +
            "</div>" +
        "</div>");
